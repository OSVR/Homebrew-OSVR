class SteamvrOsvr < Formula
  ...
  def caveats
    if self.installed? && File.exist?("#{opt_prefix}/drivers/osvr/bin/driver_osvr.dylib")
      return <<-EOS.undent
        driver_osvr.dylib was installed to:
          #{opt_prefix}/drivers/osvr/bin/driver_osvr.dylib
        ...
        You will want to symlink this driver to the SteamVR drivers location:
          ...
          ln -s "#{opt_prefix}/drivers/osvr/bin/driver_osvr.dylib" "$HOME/Library/Application Support/Steam/SteamApps/common/SteamVR/drivers/osvr/bin/osx32"
